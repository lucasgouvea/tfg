/*
package br.edu.unifei.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.edu.unifei.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "br.edu.unifei.model" });
